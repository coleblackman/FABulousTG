...
HD_PWD='/home/csb3ws/FABulousTG/FABulous_test_synthesis/FABulous_test_synthesis.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LUT4AB_ConfigMem.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LUT4AB_ConfigMem.tcl -notrace
