...
HD_PWD='/home/csb3ws/FABulousTG/FABulous_test_synthesis/FABulous_test_synthesis.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LUT4AB_ConfigMem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LUT4AB_ConfigMem.tcl
