...
// This shift register is padded to an even number of flops/latches
	wire [412-1:0] ConfigBits;
	wire [412-1:0] ConfigBitsInput;
	genvar k;

	assign ConfigBitsInput = {ConfigBits[412-1-1:0],CONFin};

	// for k in 0 to Conf/2 generate
	for (k=0; k<205; k=k+1) begin: L
		LHQD1 inst_LHQD1a(
	...
	assign CONFout = ConfigBits[412-1];
